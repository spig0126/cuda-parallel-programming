...
class bvh_node : public hittable {
  public:
    ...
    bvh_node(const hittable_list &list, float time0, float time1) : bvh_node(1, list.objects, 0, list.objects.size(), time0, time1){} // 1: root node의 nodeIdx값

    bvh_node(int idx, const std::vector<shared_ptr<hittable>> &src_objects, int start, int end, float time0, float time1);
